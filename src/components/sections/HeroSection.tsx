...
export default function HeroSection() {
  return (
    <section className="relative min-h-screen w-full overflow-hidden">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 md:px-8 pt-40 md:pt-44 pb-20 flex flex-col items-center md:items-start">
        <div className="max-w-2xl w-full text-center md:text-left md:rounded-2xl md:bg-[#0E0B0B75] md:p-10 md:backdrop-blur-sm">
